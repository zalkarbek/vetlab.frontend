  ...
  <div class="card card-body">
    ...
    <b-container fluid="true">
      ...
      <b-form-row>
        <template v-for="(field, index) in modelData.fields">
          ...
          <!--==================================================================-->
          <!--================================FIELD TYPE JSON==================================-->
          <b-col :key="index" v-if="!field.disabled && toLowerCase(field.type) === fieldTypes.json" cols="12">
            <h5 class="mg-b-10">
    ...
    <template v-if="crudButtonsEnabled">
      <b-button-group class="col-sm-12 col-md-4 col-xs-8 col-lg-4">
        <b-button v-if="!record.id"
                  variant="success" @click="createEvent()"
        >
          <i class="fal fa-save" />
          {{ $t("form.save") }}
        </b-button>
        <b-button v-if="record.id"
                  variant="warning" @click="updateEvent()"
        >
          <i class="fal fa-undo" />
          {{ $t("form.update") }}
        </b-button>
